(() => {
            ...
            return function(array) {
              function go(bot, top3) {
                switch (top3 - bot) {
                  ...
                  case 2:
                    return apply4(map9(array2)(f(array[bot])))(f(array[bot + 1]));
                  case 3:
                    return apply4(apply4(map9(array3)(f(array[bot])))(f(array[bot + 1])))(f(array[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top3 - bot) / 4) * 2;
                    return apply4(map9(concat2)(go(bot, pivot)))(go(pivot, top3));
                }
              }
  ...
  var traversableTuple = {
    traverse: function(dictApplicative) {
      var map9 = map(dictApplicative.Apply0().Functor0());
      return function(f) {
        return function(v) {
          return map9(Tuple.create(v.value0))(f(v.value1));
        };
      };
    },
    sequence: function(dictApplicative) {
      var map9 = map(dictApplicative.Apply0().Functor0());
      return function(v) {
        return map9(Tuple.create(v.value0))(v.value1);
      };
    },
    Functor0: function() {
      return functorTuple;
  ...
  var filter = function(dictOrd) {
    return coerce2(filterKeys(dictOrd));
  };
  ...
  var isPunctuation = function(c) {
    var v = generalCategory(c);
    if (v instanceof Just && v.value0 instanceof ConnectorPunctuation) {
      return true;
    }
    ;
    if (v instanceof Just && v.value0 instanceof DashPunctuation) {
      return true;
    }
    ;
    if (v instanceof Just && v.value0 instanceof OpenPunctuation) {
      return true;
    }
    ;
    if (v instanceof Just && v.value0 instanceof ClosePunctuation) {
      return true;
    }
    ;
    if (v instanceof Just && v.value0 instanceof InitialQuote) {
      return true;
    }
    ;
    if (v instanceof Just && v.value0 instanceof FinalQuote) {
      return true;
    }
    ;
    if (v instanceof Just && v.value0 instanceof OtherPunctuation) {
      return true;
    }
    ;
    return false;
  ...
  var isSymbol = function(c) {
    var v = generalCategory(c);
    if (v instanceof Just && v.value0 instanceof MathSymbol) {
      return true;
    }
    ;
    if (v instanceof Just && v.value0 instanceof CurrencySymbol) {
      return true;
    }
    ;
    if (v instanceof Just && v.value0 instanceof ModifierSymbol) {
      return true;
    }
    ;
    if (v instanceof Just && v.value0 instanceof OtherSymbol) {
      return true;
    }
    ;
    return false;
  ...
  var unwrap2 = /* @__PURE__ */ map7(snd);
  var stringParserError = {
    eof: "End of file.",
    parseFail: function(s) {
      return "Parsing failure: " + (s + ".");
    },
    invalidChar: function(c) {
      return "'" + (show2(c) + "' is an invalid character.");
    }
  };
  var parseFail = function(dict) {
    return dict.parseFail;
  };
  var parse = function(v) {
    return function(dictParserError) {
      return v(dictParserError);
    };
  };
  var lazyParser = {
    defer: function(f) {
      return function(dictParserError) {
        return function(s) {
          return parse(f(unit))(dictParserError)(s);
        };
      };
    }
  };
  var defer2 = /* @__PURE__ */ defer(lazyParser);
  var invalidChar = function(dict) {
    return dict.invalidChar;
  };
  var invalid = function(dictParserError) {
    var invalidChar1 = invalidChar(dictParserError);
    return function(c) {
      return function(dictParserError1) {
        return function(v) {
          return new Left(invalidChar1(c));
        };
      };
    };
  };
  var functorParser = {
    map: function(f) {
      return function(g) {
        return function(dictParserError) {
          return function(s) {
            return map7(map1(f))(parse(g)(dictParserError)(s));
          };
        };
      };
    }
  };
  var map22 = /* @__PURE__ */ map(functorParser);
  var eof = function(dict) {
    return dict.eof;
  };
  var parseUntil = function(dictUnfoldable) {
    var none2 = none(dictUnfoldable);
    return function(dictParserError) {
      var eof1 = eof(dictParserError);
      return function(dictEq) {
        var eq3 = eq(dictEq);
        return function(cons2) {
          return function(rev) {
            return function(p) {
              var aux = function($copy_acc) {
                return function($copy_s) {
                  var $tco_var_acc = $copy_acc;
                  var $tco_done = false;
                  var $tco_result;
                  function $tco_loop(acc, s) {
                    var v = parse(p)(dictParserError)(s);
                    if (v instanceof Left) {
                      var $70 = eq3(v.value0)(eof1);
                      if ($70) {
                        $tco_done = true;
                        return pure2(new Tuple(s, rev(acc)));
                      }
                      ;
                      $tco_done = true;
                      return new Left(v.value0);
                    ...
                    ;
                    if (v instanceof Right) {
                      $tco_var_acc = cons2(v.value0.value1)(acc);
                      $copy_s = v.value0.value0;
                      return;
                    }
                    ;
                    throw new Error("Failed pattern match at Parser (line 103, column 7 - line 105, column 50): " + [v.constructor.name]);
                  }
                  ;
                  while (!$tco_done) {
  ...
  var parseUntil1 = /* @__PURE__ */ parseUntil(unfoldableArray);
  var parseUntil$prime = function(dictParserError) {
    var parseUntil2 = parseUntil1(dictParserError);
    return function(dictEq) {
      return parseUntil2(dictEq)(cons)(reverse);
    };
  };
  var $$char = function(dictParserError) {
    var eof1 = eof(dictParserError);
    return function(s) {
      var v = uncons3(s);
      if (v instanceof Nothing) {
        return new Left(eof1);
      }
      ;
      if (v instanceof Just) {
        return new Right(new Tuple(v.value0.tail, v.value0.head));
      }
      ;
      throw new Error("Failed pattern match at Parser (line 59, column 21 - line 61, column 47): " + [v.constructor.name]);
    };
  };
  var applyParser = {
    apply: function(f) {
      return function(g) {
        return function(dictParserError) {
          return function(s) {
            var v = parse(f)(dictParserError)(s);
            if (v instanceof Left) {
              return new Left(v.value0);
            }
            ;
            if (v instanceof Right) {
              var v1 = parse(g)(dictParserError)(v.value0.value0);
              if (v1 instanceof Left) {
                return new Left(v1.value0);
              }
              ;
              if (v1 instanceof Right) {
                return new Right(new Tuple(v1.value0.value0, v.value0.value1(v1.value0.value1)));
              }
              ;
              throw new Error("Failed pattern match at Parser (line 32, column 27 - line 34, column 51): " + [v1.constructor.name]);
            }
            ;
            throw new Error("Failed pattern match at Parser (line 30, column 28 - line 34, column 51): " + [v.constructor.name]);
          };
        };
      };
    },
  ...
  var bindParser = {
    bind: function(p) {
      return function(f) {
        return function(dictParserError) {
          return function(s) {
            return bind2(parse(p)(dictParserError)(s))(function(v) {
              return parse(f(v.value1))(dictParserError)(v.value0);
            });
          };
        };
      };
  ...
  var bind1 = /* @__PURE__ */ bind(bindParser);
  var applicativeParser = {
    pure: function(x) {
      return function(dictParserError) {
        return function(s) {
          return pure2(new Tuple(s, x));
        };
      };
    },
    Apply0: function() {
  ...
  var satisfy$prime = function(dictParserError) {
    var invalid1 = invalid(dictParserError);
    return function(pred) {
      return bind1($$char)(function(c) {
        var $93 = pred(c);
        if ($93) {
          return pure1(c);
        }
  ...
  var altParser = {
    alt: function(l) {
      return function(r) {
        return function(dictParserError) {
          return function(s) {
            var v = parse(l)(dictParserError)(s);
            if (v instanceof Left) {
              return parse(r)(dictParserError)(s);
            }
            ;
            if (v instanceof Right) {
            ...
            ;
            throw new Error("Failed pattern match at Parser (line 40, column 26 - line 42, column 23): " + [v.constructor.name]);
          };
        };
      };
    },
  ...
  var some = function(dictUnfoldable) {
    return function(cons2) {
      return function(p) {
        return apply2(map22(cons2)(p))(defer2(function(v) {
          return many(dictUnfoldable)(cons2)(p);
        }));
      };
    };
  };
  var many = function(dictUnfoldable) {
    var none2 = none(dictUnfoldable);
    return function(cons2) {
      return function(p) {
        return alt2(some(dictUnfoldable)(cons2)(p))(pure1(none2));
      };
    };
  };
  var many$prime = /* @__PURE__ */ many(unfoldableArray)(cons);
  var some$prime = /* @__PURE__ */ some(unfoldableArray)(cons);
  ...
  var disj1 = /* @__PURE__ */ disj(heytingAlgebraFunction2);
  var bind12 = /* @__PURE__ */ bind(bindParser);
  ...
  var Parenthesis = /* @__PURE__ */ function() {
    function Parenthesis2(value0) {
      this.value0 = value0;
    }
    ;
    Parenthesis2.create = function(value0) {
      return new Parenthesis2(value0);
    };
    return Parenthesis2;
  }();
  var Letter = /* @__PURE__ */ function() {
    function Letter2(value0) {
      this.value0 = value0;
    }
    ;
    Letter2.create = function(value0) {
      return new Letter2(value0);
    };
    return Letter2;
  }();
  var parseSpace = function(dictParserError) {
    var satisfy$prime2 = satisfy$prime(dictParserError);
    return function(s) {
      return bind3(parse(many$prime(satisfy$prime2(function($99) {
        return isSpace(codePointFromChar($99));
      })))(dictParserError)(s))(function(v) {
        return new Right(new Tuple(v.value0, unit));
      });
    };
  };
  var isPeriod = function(c) {
    return eq2(c)(codePointFromChar("."));
  };
  var isParenthesis = function(c) {
    var rp = codePointFromChar("(");
    var lp = codePointFromChar(")");
    var $$char2 = codePointFromChar(c);
    return eq2($$char2)(lp) || eq2($$char2)(rp);
  };
  var parseParenthesis = /* @__PURE__ */ function() {
    var aux = foldl2(function(acc) {
      return function(e) {
        var $69 = e === "(";
        if ($69) {
          return acc + 1 | 0;
    ...
    return function(dictParserError) {
      var satisfy$prime2 = satisfy$prime(dictParserError);
      return function(s) {
        return bind3(parse(some$prime(satisfy$prime2(isParenthesis)))(dictParserError)(s))(function(v) {
          return new Right(new Tuple(v.value0, new Parenthesis(aux(v.value1))));
        });
      };
    };
  }();
  var isLetterOrSymbol = /* @__PURE__ */ function() {
    var $100 = disj1(isLetter)(disj1(isPunctuation)(isSymbol));
    return function($101) {
      return $100(codePointFromChar($101));
    };
  }();
  var parseLetters = function(dictParserError) {
    return bind12(some$prime(satisfy$prime(dictParserError)(conj2(isLetterOrSymbol)(not2(isParenthesis)))))(function(cs) {
      return pure3(new Letter(fromCharArray(cs)));
    });
  };
  var isDigit = /* @__PURE__ */ function() {
    var $102 = disj1(isDecDigit)(isPeriod);
    return function($103) {
      return $102(codePointFromChar($103));
    };
  }();
  var parseNumber = function(dictParserError) {
    var satisfy$prime2 = satisfy$prime(dictParserError);
    var parseFail2 = parseFail(dictParserError);
    return function(s) {
      return bind3(parse(some$prime(satisfy$prime2(isDigit)))(dictParserError)(s))(function(p) {
        var str = fromCharArray(p.value1);
        var v = fromString(str);
        if (v instanceof Nothing) {
          return new Left(parseFail2("Failed to parse " + str));
        }
        ;
        if (v instanceof Just) {
          return new Right(new Tuple(p.value0, v.value0));
        }
        ;
        throw new Error("Failed pattern match at Parse (line 55, column 3 - line 57, column 32): " + [v.constructor.name]);
      });
    };
  };
  var parseDigit = function(dictParserError) {
    return function(s) {
      return bind3(parse(parseNumber)(dictParserError)(s))(function(v) {
        return new Right(new Tuple(v.value0, new Digit(v.value1)));
      });
    };
  };
  var cutChars = /* @__PURE__ */ function() {
    var parser = parseUntil$prime(stringParserError)(eqString)(applySecond(applyParser)(parseSpace)(alt3(parseDigit)(alt3(parseLetters(stringParserError))(parseParenthesis))));
    var $104 = parse(parser)(stringParserError);
    return function($105) {
      return unwrap2($104($105));
    };
  }();

  // output/Expression/index.js
  var pure4 = /* @__PURE__ */ pure(applicativeEither);
  var sequence2 = /* @__PURE__ */ sequence(traversableTuple)(applicativeEither);
  var toUnfoldable4 = /* @__PURE__ */ toUnfoldable2(unfoldableArray);
  var filter3 = /* @__PURE__ */ filter(ordString);
  ...
  var sequence12 = /* @__PURE__ */ sequence(traversableArray)(applicativeEither);
  ...
  var Operator = /* @__PURE__ */ function() {
    function Operator2(value0) {
      this.value0 = value0;
    }
    ;
    Operator2.create = function(value0) {
      return new Operator2(value0);
    };
    return Operator2;
  }();
  ...
  var Unary = /* @__PURE__ */ function() {
    function Unary2(value0) {
      this.value0 = value0;
    }
    ;
    Unary2.create = function(value0) {
      return new Unary2(value0);
    };
    return Unary2;
  }();
  var Binary = /* @__PURE__ */ function() {
    function Binary2(value0) {
      this.value0 = value0;
    }
    ;
    Binary2.create = function(value0) {
      return new Binary2(value0);
    };
    return Binary2;
  }();
  ...
  var transformUnary = function(v) {
    return function(v1) {
      return function(v2) {
        if (v2 instanceof Value) {
          return pure4(new Value(v(v2.value0)));
        }
        ;
        if (v2 instanceof Operator) {
          return new Left("Error: Cannot " + (v1 + " a function."));
        }
        ;
        return new Left("Error: Invalid aruments for " + (v1 + "."));
      };
    };
  };
  var transformBinary = function(v) {
    return function(v1) {
      return function(v2) {
        return function(v3) {
          if (v2 instanceof Value && v3 instanceof Value) {
            return pure4(new Value(v(v2.value0)(v3.value0)));
          }
          ;
          if (v2 instanceof Operator && v3 instanceof Operator) {
            return new Left("Error: Cannot " + (v1 + " functions."));
          }
          ;
          if (v2 instanceof Value && v3 instanceof Operator) {
            return new Left("Error: Cannot " + (v1 + " a value with a function."));
          }
          ;
          if (v2 instanceof Operator && v3 instanceof Value) {
            return new Left("Error: Cannot " + (v1 + " a value with a function."));
          }
          ;
          return new Left("Error: Invalid aruments for " + (v1 + "."));
  ...
  var sinop = /* @__PURE__ */ function() {
    return new Unary({
      op: transformUnary(sin)("sin"),
      precedence: 20,
      parenthesisLevel: 0,
      name: "sin"
    });
  }();
  var runUnary = function(v) {
    return function(v1) {
      if (v1.length === 1) {
        return v.op(v1[0]);
      }
      ;
      return new Left("Error: Invalid Number of Arguments");
    };
  };
  var runBinary = function(v) {
    return function(v1) {
      if (v1.length === 2) {
        return v.op(v1[0])(v1[1]);
      }
      ;
      return new Left("Error: Invalid Number of Arguments");
    };
  };
  var runOperator = function(v) {
    return function(v1) {
      if (v instanceof Operator && v.value0 instanceof Unary) {
        var s = splitAt(1)(v1);
        return sequence2(new Tuple(s.after, runUnary(v.value0.value0)(s.before)));
      }
      ;
      if (v instanceof Operator && v.value0 instanceof Binary) {
        var s = splitAt(2)(v1);
        return sequence2(new Tuple(s.after, runBinary(v.value0.value0)(s.before)));
      }
      ;
      return new Left("Error: ???");
    };
  };
  var prefixEqual = function(p) {
    return function(s) {
      return p === take3(length3(p))(s);
    };
  };
  var power = function(v) {
    if (v instanceof Binary) {
      return (v.value0.parenthesisLevel * 100 | 0) + v.value0.precedence | 0;
    }
    ;
    ...
    ;
    throw new Error("Failed pattern match at Expression (line 208, column 1 - line 208, column 25): " + [v.constructor.name]);
  };
  var possibleStrings = function(m) {
    return function(s) {
      return toUnfoldable4(filter3(prefixEqual(s))(keys2(m)));
    };
  };
  var parseSymbols = function(m) {
    return function(s) {
      var error2 = "Error: '" + (s + "' is not a binded variable or function.");
      var aux = function($copy_acc) {
        return function($copy_sacc) {
          return function($copy_cs) {
            var $tco_var_acc = $copy_acc;
            var $tco_var_sacc = $copy_sacc;
            var $tco_done = false;
            var $tco_result;
            function $tco_loop(acc, sacc, cs) {
              var v = uncons(cs);
              if (v instanceof Nothing) {
                var $132 = sacc === "";
                if ($132) {
                ...
                ;
                $tco_done = true;
                return apply3(map8(cons)(note(error2)(lookup2(sacc)(m))))(acc);
              }
              ;
              if (v instanceof Just) {
                var $133 = 0 === length(possibleStrings(m)(sacc + singleton4(v.value0.head)));
                if ($133) {
                  var $134 = sacc === "";
                  if ($134) {
                    $tco_done = true;
                    return new Left(error2);
                  }
                  ;
                  $tco_var_acc = apply3(map8(cons)(note("This Error shouldn't be possible")(lookup2(sacc)(m))))(acc);
                  $tco_var_sacc = "";
                  $copy_cs = cs;
                  return;
                }
                ;
                $tco_var_acc = acc;
                $tco_var_sacc = sacc + singleton4(v.value0.head);
                $copy_cs = v.value0.tail;
                return;
              }
              ;
              throw new Error("Failed pattern match at Expression (line 143, column 7 - line 150, column 50): " + [v.constructor.name]);
            }
            ;
            while (!$tco_done) {
              $tco_result = $tco_loop($tco_var_acc, $tco_var_sacc, $copy_cs);
            }
            ;
            return $tco_result;
          };
      ...
      return aux(pure4([]))("")(toCharArray(s));
    };
  };
  var parenthesize = function(v) {
    return function(v1) {
      if (v1 instanceof Operator && v1.value0 instanceof Binary) {
        return new Operator(new Binary({
          op: v1.value0.value0.op,
          infix: v1.value0.value0.infix,
          precedence: v1.value0.value0.precedence,
          name: v1.value0.value0.name,
          parenthesisLevel: v1.value0.value0.parenthesisLevel + v | 0
        }));
      }
      ;
      if (v1 instanceof Operator && v1.value0 instanceof Unary) {
        return new Operator(new Unary({
          op: v1.value0.value0.op,
          precedence: v1.value0.value0.precedence,
          name: v1.value0.value0.name,
          parenthesisLevel: v1.value0.value0.parenthesisLevel + v | 0
      ...
      if (v1 instanceof Variable) {
        return new Variable({
          symbol: v1.value0.symbol,
          parenthesisLevel: v1.value0.parenthesisLevel + v | 0
        });
      }
      ;
      return v1;
  ...
  var mulop = /* @__PURE__ */ function() {
    return new Binary({
      op: transformBinary(mul(semiringNumber))("multiply"),
      precedence: 10,
      parenthesisLevel: 0,
      infix: true,
      name: "*"
  ...
  var maxPower = /* @__PURE__ */ function() {
    var aux = function(i) {
      return function(acc) {
        return function(e) {
          if (e instanceof Operator && snd(acc) < power(e.value0)) {
            return new Tuple(i, power(e.value0));
          }
          ;
          return acc;
        };
    ...
    var $198 = foldlWithIndex(foldableWithIndexArray)(aux)(new Tuple(-1 | 0, -1 | 0));
    return function($199) {
      return fst($198($199));
    };
  }();
  var lispify = function(e1) {
    return function(e2) {
      return function(a) {
        return function(i) {
          return bind4(note(e1)(index(a)(i)))(function(ati) {
            return bind4(note(e2)(index(a)(i - 1 | 0)))(function(atbi) {
              return bind4(note(e1)(updateAt(i)(atbi)(a)))(function(fs) {
                return note(e2)(updateAt(i - 1 | 0)(ati)(fs));
              });
            });
          });
        };
  ...
  var isInfix = function(v) {
    if (v instanceof Operator && v.value0 instanceof Binary) {
      return v.value0.value0.infix;
    }
    ;
    return false;
  };
  var fillVariable = function($copy_v) {
    return function($copy_v1) {
      ...
      function $tco_loop(v, v1) {
        if (v1 instanceof Variable) {
          var v2 = lookup2(v1.value0.symbol)(v);
          if (v2 instanceof Nothing) {
            $tco_done = true;
            return new Left("Error: Variable " + (v1.value0.symbol + " does not exist"));
          }
          ;
          if (v2 instanceof Just && v2.value0 instanceof Variable) {
            $tco_var_v = v;
            $copy_v1 = new Variable(v2.value0.value0);
            return;
          }
          ;
          if (v2 instanceof Just) {
            $tco_done = true;
            return pure4(parenthesize(v1.value0.parenthesisLevel)(v2.value0));
          }
          ;
          throw new Error("Failed pattern match at Expression (line 182, column 3 - line 185, column 55): " + [v2.constructor.name]);
        }
        ;
        $tco_done = true;
        return pure4(v1);
  ...
  var fillVariables = function(m) {
    return function(es) {
      return sequence12(map12(fillVariable(m))(es));
    };
  };
  var eqOperator = {
    eq: function(v) {
      return function(v1) {
        if (v instanceof Binary && v1 instanceof Binary) {
          return v.value0.name === v1.value0.name && v.value0.parenthesisLevel === v1.value0.parenthesisLevel;
        }
        ;
  ...
  var eq4 = /* @__PURE__ */ eq(eqOperator);
  ...
  var parse2 = function(m) {
    return function(s) {
      var aux = function(acc) {
        return function(pp) {
          if (pp instanceof Digit) {
            return {
              parenthesis: acc.parenthesis,
              result: map8(cons(new Value(pp.value0)))(acc.result)
            };
          }
          ;
          if (pp instanceof Parenthesis) {
            var v = bind13(hush(acc.result))(head);
            if (v instanceof Just && (v.value0 instanceof Value && pp.value0 > 0)) {
              return {
                parenthesis: acc.parenthesis + pp.value0 | 0,
                result: map8(cons(new Operator(mulop)))(acc.result)
              };
            }
            ;
            if (v instanceof Just && (v.value0 instanceof Variable && pp.value0 > 0)) {
              return {
                parenthesis: acc.parenthesis + pp.value0 | 0,
                result: map8(cons(new Operator(mulop)))(acc.result)
              };
          ...
          ;
          if (pp instanceof Letter) {
            return {
              parenthesis: acc.parenthesis,
              result: apply3(map8(append1)(map8(map12(parenthesize(acc.parenthesis)))(parseSymbols(m)(pp.value0))))(acc.result)
            };
          }
          ;
          throw new Error("Failed pattern match at Expression (line 171, column 7 - line 178, column 123): " + [pp.constructor.name]);
        };
      };
      return bind4(cutChars(s))(function(l) {
        var r = foldl2(aux)(emptyState)(l);
        return bind4(r.result)(function(result) {
          var $180 = r.parenthesis !== 0;
          if ($180) {
            return new Left("Error: Unequal number of parenthesis.");
          }
          ;
          return pure4(reverse(result));
        });
      });
    };
  };
  var deleteExtraMultiplies = function(es) {
    var aux = function($copy_v) {
      return function($copy_v1) {
        var $tco_var_v = $copy_v;
        var $tco_done = false;
        var $tco_result;
        function $tco_loop(v, v1) {
          ...
          ;
          var s = splitAt(2)(v1);
          if (s.before.length === 2 && (s["before"][0] instanceof Operator && (s["before"][1] instanceof Operator && eq4(s["before"][1].value0)(mulop)))) {
            $tco_var_v = append1(v)([new Operator(s["before"][0].value0)]);
            $copy_v1 = s.after;
            return;
          }
          ;
          $tco_var_v = append1(v)(s.before);
          $copy_v1 = s.after;
          return;
        }
        ;
  ...
  var runExpressions = function(e) {
    return function(vm) {
      var aux = function(v) {
        if (v.length === 1 && v[0] instanceof Value) {
          return pure4(v[0].value0);
        }
        ;
        var i = maxPower(v);
        return bind4(note("Error: This error should be impossible")(index(v)(i)))(function(o) {
          return bind4(function() {
            var $191 = isInfix(o);
            if ($191) {
              return lispify("Error: Invalid Number of Arguments")("Error: This error should be impossible")(v)(i);
            }
            ;
            return pure4(v);
          }())(function(nes) {
            ...
            var snes = splitAt(ni)(nes);
            return bind4(runOperator(o)(snes.after))(function(res) {
              return bind4(function() {
                var v1 = snd(res);
                if (v1 instanceof Variable) {
                  return fillVariable(vm)(new Variable(v1.value0));
                }
                ;
                return pure4(snd(res));
              }())(function(rres) {
                var nxt = append1(take(length(snes.before) - 1 | 0)(snes.before))(cons(rres)(fst(res)));
                return aux(nxt);
              });
            });
          });
      ...
      return bind4(fillVariables(vm)(e))(function(esv) {
        return aux(deleteExtraMultiplies(esv));
      });
    };
  };
  var makeEquation = function(symbols2) {
    return function(string) {
      var v = parse2(symbols2)(string);
      if (v instanceof Left) {
        return function(v1) {
          return new Left(v.value0);
        };
      ...
      if (v instanceof Right) {
        return function(variables) {
          return runExpressions(v.value0)(variables);
        };
      }
      ;
      throw new Error("Failed pattern match at Expression (line 261, column 3 - line 263, column 66): " + [v.constructor.name]);
    };
  };
  var addop = /* @__PURE__ */ function() {
    return new Binary({
      op: transformBinary(add(semiringNumber))("add"),
      precedence: 6,
      parenthesisLevel: 0,
      infix: true,
      name: "*"
  ...
  var symbols = /* @__PURE__ */ function() {
    return foldr2(uncurry(insert(ordString)))(empty2)([new Tuple("*", new Operator(mulop)), new Tuple("sin", new Operator(sinop)), new Tuple("+", new Operator(addop)), new Tuple("pi", new Value(pi)), new Tuple("x", variable("x")), new Tuple("si", variable("si")), new Tuple("o", variable("o"))]);
  }();
  var main = /* @__PURE__ */ function() {
    var equation = makeEquation(symbols)("3*2+4");
    return log2(show(showEither(showString)(showNumber))(equation(empty2)));
  }();
